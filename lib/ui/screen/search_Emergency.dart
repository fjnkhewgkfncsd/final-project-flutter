...
class _SearchEmergencyScreenState extends State<SearchEmergencyScreen> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ..._buildInstructions(emergency['title'] as String),
  ...
  List<Widget> _buildInstructions(String title) {
    // This would come from your actual data
    return [
      _buildInstructionStep('1. Stay calm and assess the situation', Icons.warning),
      _buildInstructionStep('2. Call emergency services if needed', Icons.phone),
      _buildInstructionStep('3. Follow appropriate first aid procedures', Icons.medical_services),
      _buildInstructionStep('4. Monitor the person until help arrives', Icons.access_time),
    ];
  }
